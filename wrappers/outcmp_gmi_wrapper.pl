...
# Usage : perl outcmp_gmi_wrapper.pl <directory> <nbnodes> <args>
#
...
my $cmd = "perl /home1/codmon/codmon/wrappers/outcmp_wrapper.pl $localdir $dir/$class.out.sample /home1/codmon/codmon/wrappers/run-gmi  $nbnodes $runargs"; 
#print $cmd."\n";
`$cmd`;
