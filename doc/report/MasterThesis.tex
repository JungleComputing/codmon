...
the same init and sonsor file. The first time they ran without errors. The second time we've added a ErrorTest to project's JUnit-test set.The results are shown in the next section.\\
