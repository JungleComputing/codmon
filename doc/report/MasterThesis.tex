...
\label{test}
In this section we describe how we have tested \project{} with an independent Java project. With the testing of an independent project int the \project{} environment, we want show that \project{} is a 
\emp{multi-platform modular} test environment. The tests should also show that it is a \emph{user-friendly} environment. 
...
chose to use the \emph{Marc4j}\cite{marc4j} project.
