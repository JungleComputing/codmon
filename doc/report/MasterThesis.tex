...
\noindent In the previous sections we have shown that Codmon has some good aspects as well as some aspects that aren't that good. To design a test environment which satisfies the above requirements 
...
it if there was no other option. In the section \ref{sec:Codmon2.0} we'll show where and why we've adapted the Codmon core program. Because the Codmon core program is written in Java already we've 
decided to write the Wrappers in Java as well. Using as litle languages as possible will help the people who have to maintain te environment.
