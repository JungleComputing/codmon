...
\label{test}
Our goal was to show that \project{} is a \emph{multi-platform}, \emph{modular} and \emph{user-friendly} test environment. This chapter described the tests that were performed to assess this. We did this 
...
\label{test:prep}
To show that \project{} is a \emph{multi-platform}, \emph{modular} and \emph{user-friendly} test environment we tested an existing software project in the \project{} environment. Tthere were a few 
