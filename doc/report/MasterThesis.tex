...
software that the users want to test. If this modules all implement the same interface, it is easy for (extern-) developers to add new version control systems. The only thing a user has to do, is indicate which 
