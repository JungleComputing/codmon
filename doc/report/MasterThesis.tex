...
\emph{cmd}-attribute. In the sensor of listing \ref{list:imp_sensor} the wrapper will be the \emph{TimeWrapper}, while the Ant-target will be \emph{"run"}.\\
...
\noindent TODO: netjes een eind aan deze sectie maken.
