...
the sensor file, messures the build time of the CheckoutApplications project and both the checkout and build time of the \emph{Marc4j} project. There are no credentials needed for checking out the
